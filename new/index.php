...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
            ...
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Recent Toasts</h2>
                        <p>Here are some toasts to start with</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
	...
	include '../includes/config.php';
                	try{
                		$stmt = $db->query('SELECT postID, postTitle, postAuthor, postCont, postSlug, postDesc, postDate, postView, service FROM blog_posts_seo ORDER BY postID DESC ');
	                	while($row = $stmt->fetch()){
                    
                                    echo '<div class="col-md-3 col-sm-6"><div class="service-item" id="service-'.$row['service'].'"><div class="service-icon">';
                            
                                    echo '<h3><a href="viewpost.php?id='.$row['postSlug'].'">'.$row['postTitle'].'</a></h3>';
                                    
                                    echo '<div class="post-info"><h4>';
                                    ...
                                    echo 'By '.$authorName['full_name'].' in ';
                                    ...
                                    echo 'Posted on '.date('jS M Y H:i:s', strtotime($row['postDate']));
                                    
                                    echo '</h4></div></div><div class="service-content"><div class="inner-service"><h3>';
									...
									/*$position = 50; // Define how many characters you want to display.

 
									// Find what is the last character.
									$post = substr($row['postCont'],$position,1);
									...
									$post = substr($row['postCont'],0,$position); 
                                    ...
                                    echo '<a class="read-more" href="viewpost.php?id='.$row['postSlug'].'">Read More</a>';
