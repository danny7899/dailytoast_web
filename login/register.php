...
***********************************************************/
  $page_title="Register - Daily Toast";
...
$adminmessage = 
"Hello Administrator,\n
We have a new member signed up. Here are their login details...\n
...
";
    ...
    "From: \"Member Registration\" <danny7899@dailytoast.dx.am>\r\n" .
     "X-Mailer: PHP/" . phpversion());
$admin_email='admin@dailytoast.dx.am';
    mail($admin_email,"New Member", $adminmessage,
    "From: \"Member Registration\" <danny7899@dailytoast.dx.am>\r\n" .
     "X-Mailer: PHP/" . phpversion());
...
?>
    ...
    <main>
      <section>
        ...
        <?php 
     if (isset($_GET['done'])) { ?>
      <h2>Thank you</h2> <article><p>Your registration is now complete and you can <a href="login.php">login here</a></p></article>
     <?php exit();
      }
    ?>
      <h2>Signup</h2><article>
      <p>Please register a free account, before you can start posting your Toasts.</p>
      <p>Registration is quick and free! Please note that fields marked <span class="required">*</span> 
        are required.</p>
     <?php  
     if(!empty($err))  {
       echo "<div class=\"msg\">";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
     ...
     <form action="register.php" method="post" name="regForm" id="regForm" >
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
            <td colspan="2"><span class="example"><h4><strong>Valid Contact Details</strong></h4></span></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2">Contact Address<span class="required"><font color="#CC0000">*</font></span><br> 
              <textarea name="address" cols="40" rows="4" id="address" class="required"></textarea>
            </td>
          </tr>
        
          <tr> 
            <td>Country <font color="#CC0000">*</font></td>
          ...
          <tr> 
            <td>Your Email<span class=""><font color="#CC0000">*</font></span> 
            </td>
          ...
          <tr> 
            <td width="22%"><h4><strong>Verification </strong></h4></td>
            <td width="78%"> 

              <div class="g-recaptcha" data-sitekey="6Leh-wYTAAAAAHoYmI1OrQdUIZscQUCW5oDo-jZC"></div>
